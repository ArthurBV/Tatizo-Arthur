 ...
 * @author Arturo
 */
public class Entrenamiento_AccionesCaso4 extends javax.swing.JFrame {
     ...
     */
    public Entrenamiento_AccionesCaso4() {
        initComponents();
        ...
        if(row==14){
            ...
            program = 4;
            String question = html1 +"300" + html2 +"¿Qué aplicación debo usar para revisar la presencia de errores en la interface del enrutador?";
            Entrenamiento_SeleccionMG1 seleccionMG = new Entrenamiento_SeleccionMG1(question, program, 1, caso);
            seleccionMG.setVisible(true);
            this.setVisible(false);
        ...
        if(row==15){
            ...
            program = 4;
            String question = html1 +"300" + html2 +"¿Qué aplicación debo usar para revisar la configuración de la negociación en la interface del enrutador?";
            Entrenamiento_SeleccionMG1 seleccionMG = new Entrenamiento_SeleccionMG1(question, program, 2, caso);
            seleccionMG.setVisible(true);
            this.setVisible(false);
        ...
        if(row==27){
            ...
            this.setVisible(false);
            op0 = 46;
            op1 = html1 +"300" + html2 +"Podria por favor confirmarme cual es la negociacion de su switch, para verificar que sea la misma de la interface LAN de nuestro enrutador?";
            op2 = html1 +"300" + html2 +"Estoy escalando caso al segundo nivel para enviar personal tecnico para revision en el punto";
            op3 = html1 +"300" + html2 +"Podria configurar sus equipos en 'Auto' para garantizar la negociacion con nuestros equipos? ";
        ...
        if(row==33){
            ...
            program = 7;
            String question = html1 +"300" + html2 +"¿Qué aplicación debo usar para cambiar la negociación en el enrutador?";
            Entrenamiento_SeleccionMG1 seleccionMG = new Entrenamiento_SeleccionMG1(question, program, 0, caso);
            seleccionMG.setVisible(true);
            this.setVisible(false);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                ...
                {html1 +"200" + html2 +"Estoy revisando si existen errores en la interface del enrutador ", "2", "Actuar"},
                {html1 +"200" + html2 +"Estoy revisando la configuración de la negociación en la interface del enrutador ", "2", "Actuar"},
                ...
                {html1 +"200" + html2 +"De acuerdo con las pruebas realizadas, se observa perdida de paquetes en la interface por errores en la interface Lan. Voy a proceder con la apertura del caso, de acuerdo? ", "1", "Actuar"},
                ...
                {html1 +"200" + html2 +"Estoy cambiando la negociación en el enrutador ", "3", "Actuar"},
    ...
    Entrenamiento_DescripcionCaso4 descripcion = new Entrenamiento_DescripcionCaso4();
