...
public class Entrenamiento_Acciones extends javax.swing.JFrame {
    ...
    public Entrenamiento_Acciones() {
        ...
        if(row==8){
            ...
            //Estoy revisando en nuestro sistema de monitoreo las ultimas caidas que ha tenido el canal

        if(row==9){
            
            JOptionPane.showMessageDialog(null, "Si pero no. Revisar los ultimos eventos del canal esta bien, sin embargo, debes concentrarte en la lentitud reportada por el cliente.");
        ...
        if(row==14){
            ...
            JOptionPane.showMessageDialog(null, "Esta bien. Es importante validar los errores en las interfaces para comprobar la salud de la red. Sin embargo, verifica primero el trafico del canal y luego, si lo consideras necesario, tomas esta opcion. ");
        ...
        if(row==18){
            ...
            JOptionPane.showMessageDialog(null, "No ayuda mucho!.  Cuando se trata de lentitud, concentrate en diagnosticar sintomas relacionados con dicha lentitud. Esta accion no sera de gran ayuda y perderas tiempo revisandola.");
        ...
        if(row==19){
            ...
            JOptionPane.showMessageDialog(null, "Esta bien. Es importante validar las caidas que ha tenido el canal para comprobar la salud de la red. Sin embargo, cuando se trata de lentitud, concentrate en diagnosticar sintomas relacionados con dicha lentitud.");
        ...
        if(row==20){
          ...
          JOptionPane.showMessageDialog(null, "Esta bien. Es importante validar si el canal tuvo algun evento electrico. Sin embargo, cuando se trata de lentitud, concentrate en diagnosticar sintomas relacionados con dicha lentitud.");
        ...
        if(row==23){
          ...
          JOptionPane.showMessageDialog(null, "No, Este no es el requerimiento del cliente, concentrate en acordar con el cliente y presta mucha atención a lo que dice.");
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {html1 +"200" + html2 +"Podría por favor repetir su solicitud? ", "3", "Acción"},
                {html1 +"200" + html2 +"Podría por favor indicarme la ip Lan o Wan del servicio ", "3", "Acción"},
                {html1 +"200" + html2 +"Para responder a su solicitud debe comunicarse mas tarde", "0", "Acción"},
                {html1 +"200" + html2 +"Podría confirmarme cual es el ancho de banda de su canal", "3", "Acción"},
                {html1 +"200" + html2 +"Recuerda cuando fue la última caida de su servicio?", "3", "Acción"},
                {html1 +"200" + html2 +"Permitame lo comunico con el área encargada", "0", "Acción"},
                {html1 +"200" + html2 +"Permítame lo comunico con el ingeniero que tiene el caso", "0", "Acción"},
                {html1 +"200" + html2 +"Estoy revisando la infraestructura tecnológica instalada ", "2", "Acción"},
                {html1 +"200" + html2 +"Estoy revisando en nuestro sistema de monitoreo las ultimas caidas que ha tenido el canal", "0", "Acción"},
                {html1 +"200" + html2 +"Estoy revisando la gráfica de trafico del canal ", "2", "Acción"},
                {html1 +"200" + html2 +"Estoy haciendo pruebas de rendimiento del canal  ", "2", "Acción"},
                {html1 +"200" + html2 +"Estoy revisando el ancho de banda configurado en la interface del enrutador ", "2", "Acción"},
                {html1 +"200" + html2 +"Estoy verificando la configuración del ancho de banda en los equipos del backbone ", "2", "Acción"},
                {html1 +"200" + html2 +"Estoy revisando si existen errores en la interface del enrutador ", "0", "Acción"},
                {html1 +"200" + html2 +"Estoy revisando la configuración de la negociación en la interface del enrutador ", "0", "Acción"},
                {html1 +"200" + html2 +"Estoy verificando el trafico actual en la interface del enrutador ", "2", "Acción"},
                {html1 +"200" + html2 +"Estoy revisando los últimos casos abiertos para esta sede ", "0", "Acción"},
                {html1 +"200" + html2 +"Estoy verificando la configuración de enrutamiento estático en el enrutador ", "0", "Acción"},
                {html1 +"200" + html2 +"Estoy revisando las últimas caidas que ha tenido el canal en el enrutador ", "0", "Acción"},
                {html1 +"200" + html2 +"Estoy verificando el último reinicio eléctrico en el router ", "0", "Acción"},
                {html1 +"200" + html2 +"Estoy revisando el protocolo de entrega de ips configurado en el enrutador ", "0", "Acción"},
                {html1 +"200" + html2 +"De acuerdo con las pruebas realizadas, se observa saturación en el canal. Voy a proceder con la apertura del caso, de acuerdo? ", "1", "Acción"},
                {html1 +"200" + html2 +"Confirmo su solicitud de configuración de ruta estatica en el enrutador. Voy a proceder con la apertura del caso, de acuerdo? ", "0", "Acción"},
                {html1 +"200" + html2 +"De acuerdo con las pruebas realizadas, se observa intermitencias en el canal, posiblemente por inconvenientes en la Ultima milla. Voy a proceder con la apertura del caso, de acuerdo? ", "0", "Acción"},
                {html1 +"200" + html2 +"De acuerdo con las pruebas realizadas, se observa bloqueo de ips. Voy a proceder con la apertura del caso, de acuerdo? ", "0", "Acción"},
                {html1 +"200" + html2 +"De acuerdo con las pruebas realizadas, se observan errores en la interface Lan. Voy a proceder con la apertura del caso, de acuerdo? ", "0", "Acción"},
                {html1 +"200" + html2 +"Puedo ofrecerle las siguientes alternativas: ", "2", "Acción"},
                {html1 +"200" + html2 +"Estoy configurando el ip_accounting solicitado ", "3", "Acción"},
                {html1 +"200" + html2 +"Le estoy enviando correo con la información del tráfico para su revisión ", "3", "Acción"},
                {html1 +"200" + html2 +"Estoy comunicandole al Service Manager su solicitud ", "0", "Acción"},
                {html1 +"200" + html2 +"Estoy escalando caso para Ingeniero de Operaciones para el cambio solicitado ", "0", "Acción"},
                {html1 +"200" + html2 +"Estoy reiniciando el DHCP en el enrutador ", "0", "Acción"},
                {html1 +"200" + html2 +"Estoy cambiando la negociación en el enrutador ", "0", "Acción"},
                {html1 +"200" + html2 +"Estoy escalando el caso a segundo nivel para revisión con el proveedor ", "0", "Acción"},
                {html1 +"200" + html2 +"Usted puede crear un caso con su solicitud, estaremos informando avances ", "3", "Acción"},
                {html1 +"200" + html2 +"Usted puede enviarnos un correo electronico y nos comunicaremos con usted cuando este resuelta su solcitud ", "3", "Acción"}
            },
            new String [] {
        ...
        if (jTable1.getColumnModel().getColumnCount() > 0) {
            ...
            jTable1.getColumnModel().getColumn(0).setHeaderValue("Acción");
            jTable1.getColumnModel().getColumn(1).setResizable(false);
            jTable1.getColumnModel().getColumn(1).setHeaderValue("Tiempo (min)");
            jTable1.getColumnModel().getColumn(2).setResizable(false);
            jTable1.getColumnModel().getColumn(2).setHeaderValue("Actuar");
        }
